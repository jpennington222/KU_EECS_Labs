...
class minHeap
{
  public:
    ...
    */
    ...
    /*
    * @pre: Heap built
    * @post: The heap is printed in level order if key < 22
    * @return: none
    */

    void levelOrderAvailable();
    ...
    */
    ...
    int current(std::string first, std::string last);

    /*
    * @pre: Heap built
    * @post: Computes if key < 22
    * @param first: First name
    * @param last: Last name
    * @return: True if available, otherwise false
    */

    bool checkDoctor(std::string first, std::string last);
